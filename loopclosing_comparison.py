...
Defaults to the sequences that actually close loops rather than the four the other
comparisons use; a system that never closed a loop on a sequence has no bar there,
and how many runs each bar rests on is printed rather than drawn.

Usage:
    ./loopclosing_comparison.py
    ./loopclosing_comparison.py --sequences room3 outdoors5 --out figures
"""
