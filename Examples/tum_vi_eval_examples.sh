...
CUDA_MODULE_LOADING=LAZY ./Stereo-Inertial/stereo_inertial_tum_vi ../Vocabulary/ORBvoc.txt ${config_file} ${pathDatasetTUM_VI}/dataset-${dataset_name}_512_16/mav0/cam0/data ${pathDatasetTUM_VI}/dataset-${dataset_name}_512_16/mav0/cam1/data Stereo-Inertial/TUM_TimeStamps/dataset-${dataset_name}_512.txt Stereo-Inertial/TUM_IMU/dataset-${dataset_name}_512.txt  ${file_name} ${statsDir} ${FastTrack_on} ${TurboMap_on} ${FastLoop_on} ${kernel_status_FT} ${kernel_status_TM} ${kernel_status_FL}
